...
*
* Note: The Low level hardware interface facilities
...
class EncoderHW{
    public: 
        ...
        virtual void enable( uint index ) = 0;// Enable a individual encoder ch
        virtual void disable( uint index ) = 0; // Disable a individual encoder ch
